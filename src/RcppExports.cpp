...
RcppExport SEXP _techchart_bias_cpp(SEXP dataSEXP, SEXP orderside_longSEXP, SEXP max_mins_waitSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(bias_cpp(data, orderside_long, max_mins_wait));
    return rcpp_result_gen;
END_RCPP
}
// cpt_trend
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_techchart_bias_cpp", (DL_FUNC) &_techchart_bias_cpp, 3},
